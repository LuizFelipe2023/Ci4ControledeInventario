        ...
        <div class="col-md-8 col-lg-6">
            <div class="card shadow border-light">
                <div class="card-header" style="background-color: #3a5b7d; color: white; text-align: center;">
                    <h2 class="mb-0">Adicionar Novo Cliente</h2>
                </div>
                <div class="card-body">
                    ...
                    <form id="clienteForm" action="<?= site_url('clientes/insert') ?>" method="post" enctype="multipart/form-data">
                        <?= csrf_field() ?>
                        <div class="mb-3">
                        ...
                        <button type="submit" class="btn btn-success mb-3">Adicionar Cliente</button>
